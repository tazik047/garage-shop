                ...
                <htab title="<?php echo $l->get('tab_field_main', true) ?>" title-lang-id="tab_field_main">
                    <table class="form">
                        <tr ng-init="field.label= !empty(field.label) ? field.label : {}">
                            ...
                            <td>
                                <div ng-repeat="l in languages"><img ng-src="language/{{l.code}}/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="field.label[l.code]"></div>
                            </td>    
                        </tr>
                        ...
                        <tr ng-init="field.description= !empty(field.description) ? field.description : {}">
                            ...
                            <td>
                                <div ng-repeat="l in languages"><img style="vertical-align:top;" ng-src="language/{{l.code}}/{{l.image}}" />&nbsp;<textarea  cols="50" ng-model="field.description[l.code]"></textarea></div>
                            </td>    
                        </tr>
                        ...
                        <tr ng-if="inArray(field.type, typesWithPlaceholder)" ng-init="field.placeholder= !empty(field.placeholder) ? field.placeholder : {}">
                            ...
                            <td>
                                <div ng-repeat="l in languages"><img ng-src="language/{{l.code}}/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="field.placeholder[l.code]"></div>
                            </td>    
                        </tr>
                        ...
                        <tr ng-if="inArray(field.type, typesWithValues)" ng-init="field.values = !empty(field.values) ? field.values : {}">
                            ...
                            <td>
                                <div ng-if="field.values.source == 'saved'" ng-init="field.values.saved = !empty(field.values.saved) ? field.values.saved : {}">
                                    <div ng-repeat="l in languages"><img style="vertical-align:top;" ng-src="language/{{l.code}}/{{l.image}}" />&nbsp;<textarea ng-model="field.values.saved[l.code]" ng-keyup="parseValues(field.id, l.code, field.values.saved[l.code])" cols="150" placeholder="Example: value1=text1;value2=text2;value3=text3"></textarea></div>
                                </div>
                            ...
                            <td>
                                <table class="form" ng-if="field.rules.notEmpty.enabled">
                                    <tr ng-init="field.rules.notEmpty.errorText= !empty(field.rules.notEmpty.errorText) ? field.rules.notEmpty.errorText : {}">
                                        ...
                                        <td><div ng-repeat="l in languages"><img ng-src="language/{{l.code}}/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="field.rules.notEmpty.errorText[l.code]"></div></td>
                                    </tr>
                                </table>
                            </td>    
                        </tr>
                            ...
                            <td>
                                <table class="form" ng-if="field.rules.equal.enabled">
                                    ...
                                    <tr ng-init="field.rules.equal.errorText= !empty(field.rules.equal.errorText) ? field.rules.equal.errorText : {}">
                                        <td><?php echo $l->get('text_rule_error') ?></td>
                                        <td><div ng-repeat="l in languages"><img ng-src="language/{{l.code}}/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="field.rules.equal.errorText[l.code]"></div></td>
                                    </tr>
                                </table>
                            </td>    
                        </tr>
                            ...
                            <td>
                                <table class="form" ng-if="field.rules.byLength.enabled">
                                    ...
                                    <tr ng-init="field.rules.byLength.errorText= !empty(field.rules.byLength.errorText) ? field.rules.byLength.errorText : {}">
                                        <td><?php echo $l->get('text_rule_error') ?></td>
                                        <td><div ng-repeat="l in languages"><img ng-src="language/{{l.code}}/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="field.rules.byLength.errorText[l.code]"></div></td>
                                    </tr>
                                </table>
                            </td>    
                        </tr>
                            ...
                            <td>
                                <table class="form" ng-if="field.rules.regexp.enabled">
                                    ...
                                    <tr ng-init="field.rules.regexp.errorText= !empty(field.rules.regexp.errorText) ? field.rules.regexp.errorText : {}">
                                        <td><?php echo $l->get('text_rule_error') ?></td>
                                        <td><div ng-repeat="l in languages"><img ng-src="language/{{l.code}}/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="field.rules.regexp.errorText[l.code]"></div></td>
                                    </tr>
                                </table>
                            </td>    
                        </tr>
                            ...
                            <td>
                                <table class="form" ng-if="field.rules.api.enabled">
                                    ...
                                    <tr ng-init="field.rules.api.errorText= !empty(field.rules.api.errorText) ? field.rules.api.errorText : {}">
                                        <td><?php echo $l->get('text_rule_error') ?></td>
                                        <td><div ng-repeat="l in languages"><img ng-src="language/{{l.code}}/{{l.image}}" />&nbsp;<input type="text" size="50" ng-model="field.rules.api.errorText[l.code]"></div></td>
                                    </tr>
                                </table>
                            </td>    
                        </tr>
