<div class="list-group">
  ...
  <?php /* <a href="<?php echo $download; ?>" class="list-group-item"><?php echo $text_download; ?></a> */ ?>
  <?php /* <a href="<?php echo $recurring; ?>" class="list-group-item"><?php echo $text_recurring; ?></a> */ ?>
  <?php /*  <a href="<?php echo $reward; ?>" class="list-group-item"><?php echo $text_reward; ?></a> */?>
