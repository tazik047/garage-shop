  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
<a href="<?php echo $manufacturer['href']; ?>"><?php if ( $manufacturer['manufacture_image'] ) { ?><img src="<?php echo $manufacturer['manufacture_image']; ?>" class="img-responsive img-brend" /><?php } ?></a>
