    ...
    public function index($args = null) {
        ...
        if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            if ($this->validate() && !$this->simplecheckout->isOrderBlocked() && $this->simplecheckout->canCreateOrder()) {
                ...
                $this->_templateData['simple_blocks']['payment_form'] = $this->getChildController('extension/payment/' . $payment_method['code']);

                /*print '<pre>';
                print_r($this->_templateData['simple_blocks']['payment_form']);
                die();*/
            ...
            $this->_templateData['text_agreement'] = sprintf($this->language->get($langId), $this->url->link('information/information', $this->simplecheckout->getAdditionalParams() . 'information_id=' . $this->simplecheckout->getSettingValue('agreementId'), true), $title, $title);
